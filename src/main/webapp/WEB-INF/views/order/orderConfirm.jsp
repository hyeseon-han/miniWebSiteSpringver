...
<script>
	$(document).ready(function() {
		...
		$("#same").on("click",function(){
			var orderName = $("#mname").val();
			var sample4_postcode = $("#mpost").val();
			var sample4_roadAddress = $("#maddress1").val();
			var sample4_jibunAddress = $("#maddress2").val();
			var phone = $("#mphone").val();
			$("#orderName").val(orderName);
			$("#sample4_postcode").val(sample4_postcode);
			$("#sample4_roadAddress").val(sample4_roadAddress);
			$("#sample4_roadAddress").val(sample4_roadAddress);
			$("#sample4_jibunAddress").val(sample4_jibunAddress);
			$("#phone").val(phone);
		})
	});
</script>
...
<!-- 수정 부분 -->
<form action="loginCheck/orderDone" method="get" name="myForm">
<!-- 실제 주문을 하게 됨 , 아래에서 상품에 대한 정보를 숨겨서 넘김-->
		...
		<td>
			<table width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="td_default" width="80"><img src="images/items/${Cdto.gImage}.gif"
						border="0" align="center" width="80" /></td>
					<td class="td_default" width="100" style='padding-left: 30px'>
						<br> <font size="2" color="#665b5f">[옵션 : 사이즈(${Cdto.gSize}) ,
							색상(${Cdto.gColor})] </font>
					</td>
					<td class="td_default" align="center" width="80">${Cdto.gPrice}</td>
					<td class="td_default" align="center" width="80">${Cdto.gAmount}</td>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="1"
				...
				<tr>
					...
					<td height="35" class="td_default">
						...
						maxlength="200" value="${Mdto.addr1}" readonly></input><br> <input class="input_default" type="text" id="maddress2"
			size="35" maxlength="200" value="${Mdto.addr2}" readonly></input>
		</td>
	</tr>
